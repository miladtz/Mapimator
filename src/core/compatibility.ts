...
export const DATASET_REGISTRY: readonly DatasetRegistryEntry[] = [
  {
    ...
    description: 'Legacy dataset capability retained for portable-project compatibility.',
    required: false,
    installed: true,
  },
  {
    id: 'mapmotion-natural-earth-world',
    version: '1.0.0',
    displayName: 'MapMotion Natural Earth World',
    description: 'Bundled Natural Earth 1:50m political, physical, and multilingual world map.',
    required: true,
    installed: true,
  },
] as const;
